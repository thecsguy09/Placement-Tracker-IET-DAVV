...
export const Modal = ({ isOpen, onClose, companyDetails }) => {
  ...
  {companyDetails['S. No'] && <DetailItem label="S. No" value={companyDetails['S. No']} />}
  {companyDetails.Date && <DetailItem label="Date" value={companyDetails.Date} />}
  {companyDetails.Company && <DetailItem label="Company" value={companyDetails.Company} />}
  ...
  {companyDetails['CTC (in LPA)'] && (
    <DetailItem
      label="Salary Package (in LPA)"
      value={formatNumber(companyDetails['CTC (in LPA)'])}
      highlight
    />
  )}
  {companyDetails['Total Offers'] && (
